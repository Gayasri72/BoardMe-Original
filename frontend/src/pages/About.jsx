        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-blue-100 shadow-md rounded-lg p-6">
              <img src="./src/assets/about/member2.jpeg" alt="Team Member" className="w-32 h-32 rounded-full mx-auto mb-4" />
            ...
            <div className="bg-green-100 shadow-md rounded-lg p-6">
              <img src="./src/assets/about/member3.jpeg" alt="Team Member" className="w-32 h-32 rounded-full mx-auto mb-4" />
            ...
            <div className="bg-yellow-100 shadow-md rounded-lg p-6">
              <img src="./src/assets/about/member4.jpeg" alt="Team Member" className="w-32 h-32 rounded-full mx-auto mb-4" />
